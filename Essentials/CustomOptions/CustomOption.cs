...
namespace Essentials.CustomOptions
{
    ...
    /// </summary>
    public abstract partial class CustomOption
    {
        /// <summary>
        ...
        private static string GetCallingPluginId()
        {
            ...
            for (int i = 3; i < stackTrace.GetFrames().Length; i++)
            {
                MethodBase method = stackTrace.GetFrame(i).GetMethod();
                Type type = method.ReflectedType;

                //Essentials.Logger.LogInfo($"Frame {i}: {method.Name} {type} {type.IsClass} {type.IsClass && type.IsSubclassOf(typeof(BasePlugin))}");
                ...
                {
                    //Essentials.Logger.LogInfo($"Attribute {attribute.AttributeType}");
                    ...
                    if (arg == null || arg.ArgumentType != typeof(string) || !(arg.Value is string value)) continue;
    ...
    public class CustomToggleOption : CustomOption
    {
        ...
        {
            if (!(o is ToggleOption toggle)) return;
    ...
    public class CustomNumberOption : CustomOption
    {
        ...
        private protected override void GameOptionCreated(OptionBehaviour o)
        {
            if (!(o is NumberOption number)) return;
    ...
    public class CustomStringOption : CustomOption
    {
        ...
        private protected override void GameOptionCreated(OptionBehaviour o)
        {
            if (!(o is StringOption str)) return;
